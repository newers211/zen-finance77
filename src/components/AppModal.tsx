      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-white dark:bg-zinc-900 rounded-[32px] shadow-2xl border border-zinc-100 dark:border-zinc-800 p-6 overflow-hidden"
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed mb-6">{message}</p>
              <div className={`flex gap-3 w-full ${secondaryButton ? '' : 'flex-col'}`}>
                {secondaryButton && (
                  <button
                    ...
                    className="flex-1 py-4 rounded-2xl font-bold text-zinc-600 dark:text-zinc-300 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors active:scale-[0.98]"
                  >
